...
local function chat_list(msg)
    local data = load_data(_config.moderation.data)
        ...
        local message = 'لیست گروه های موجود\n\nبا دستور \n/join (id) \nبه گروه مورد نظرافزده میشوید \n___________________________\n'
